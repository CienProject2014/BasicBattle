...
public class Main {
	public static void main(String[] args) { 
		Hero hero1 = new Hero("Hero", "hero1",
				new Status(100, 20, 10, 10, 10, 90, 0, "normal", 1));
		Hero hero2 = new Hero("Hero", "hero2", 
				new Status(100, 20, 10, 10, 10, 90, 0, "normal", 3));
		Hero hero3 = new Hero("Hero", "hero3", 
				new Status(100, 20, 10, 10, 10, 90, 0, "normal", 6));
		Monster monster1 = new Monster("Monster", "Monster1",
				new Status(100, 20, 10, 10, 10, 50, 0, "normal", 2));
		Monster monster2 = new Monster("Monster", "Monster2",
				new Status(100, 20, 10, 10, 10, 50, 0, "normal", 4));
		Monster monster3 = new Monster("Monster", "Monster3",
				new Status(100, 20, 10, 10, 10, 50, 0, "normal", 5));
